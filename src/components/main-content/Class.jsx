...
function Class({name, courseCode, professor, courseHours, officeHours, assignments}) {
    return (
       <div className="assignment-class">
            <div className="class-header">
              ...
              {assignments.map(assignment => (<Assignment name={assignment.name} priority={assignment.priority} dueDate={assignment.dueDate}/>))}
            </div>
          </div>
    );
}
